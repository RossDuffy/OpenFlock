...
public class Flock : MonoBehaviour
{
    ...
    // Maybe move this to each behaviour
    // This will allow each behaviour to consider a different radius
    // Need something like this in order to make predator behaviour effective
